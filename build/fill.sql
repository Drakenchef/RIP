...
INSERT INTO flight_requests (id,date_create,date_formation, date_completion, status, AMS, user_id,moder_id) VALUES (1,'2020-01-01','2022-01-01', '2022-01-10', 'заполняется', 'AMS123', 1,4);
INSERT INTO flight_requests (id,date_create,date_formation, date_completion, status, AMS, user_id,moder_id) VALUES (2,'2021-02-07','2022-02-01', '2022-02-10', 'заполняется', 'AMS456', 2,4);
INSERT INTO flight_requests (id,date_create,date_formation, date_completion, status, AMS, user_id,moder_id) VALUES (3,'2021-04-02','2022-03-01', '2022-03-10', 'заполняется', 'AMS789', 3,4);
