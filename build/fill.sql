...
INSERT INTO flight_requests (date_create,date_formation, date_completion, status, AMS, user_id,moder_id) VALUES ('2020-01-01','2022-01-01', '2022-01-10', 'создан', 'AMS123', 1,3);
INSERT INTO flight_requests (date_create,date_formation, date_completion, status, AMS, user_id,moder_id) VALUES ('2021-02-07','2022-02-01', '2022-02-10', 'в работе', 'AMS456', 2,3);
INSERT INTO flight_requests (date_create,date_formation, date_completion, status, AMS, user_id,moder_id) VALUES ('2021-04-02','2022-03-01', '2022-03-10', 'отменён', 'AMS789', 2,3);
