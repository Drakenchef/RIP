...
func (h *Handler) RegisterHandler(router *gin.Engine) {
	...
	router.Use(h.WithAuthCheck(role.Manager, role.Admin)).POST("/Planets", h.AddPlanet)
	//router.PUT("/Planets/:id", h.UpdatePlanet)
	router.Use(h.WithAuthCheck(role.Manager, role.Admin)).PUT("/Planets/:id", h.UpdatePlanet)
	//router.DELETE("/Planets", h.DeletePlanet)
	router.Use(h.WithAuthCheck(role.Manager, role.Admin)).DELETE("/Planets", h.DeletePlanet)
	//router.POST("/PlanetImage", h.AddImage)

	//router.GET("/Flights", h.FlightsList)
	router.Use(h.WithAuthCheck(role.Buyer, role.Manager, role.Admin)).GET("/Flights", h.FlightsList)
	//router.GET("/Flights/:id", h.FlightById)
	router.Use(h.WithAuthCheck(role.Buyer, role.Manager, role.Admin)).GET("/Flights/:id", h.FlightById)
	//router.DELETE("/Flights", h.DeleteFlight)
	router.Use(h.WithAuthCheck(role.Buyer, role.Manager, role.Admin)).DELETE("/Flights", h.DeleteFlight)
	//router.PUT("/Flights", h.UpdateFlight)
	router.Use(h.WithAuthCheck(role.Buyer, role.Manager, role.Admin)).PUT("/Flights", h.UpdateFlight)
	//router.PUT("/FlightsUser/:id", h.UserUpdateFlightStatusById)
	router.Use(h.WithAuthCheck(role.Buyer, role.Manager, role.Admin)).PUT("/FlightsUser/:id", h.UserUpdateFlightStatusById)
	//router.PUT("/FlightsModer/:id", h.ModerUpdateFlightStatusById)
	router.Use(h.WithAuthCheck(role.Manager, role.Admin)).PUT("/FlightsUser/:id", h.ModerUpdateFlightStatusById)
	//router.GET("/UsersFlight", h.UsersFlight)
	router.Use(h.WithAuthCheck(role.Buyer, role.Manager, role.Admin)).PUT("/UsersFlight", h.UsersFlight)
	...
	router.Use(h.WithAuthCheck(role.Buyer, role.Manager, role.Admin)).POST("/PlanetsRequests", h.AddPlanetToRequest)
	//router.DELETE("/PlanetsRequests", h.DeletePlanetRequest)
	router.Use(h.WithAuthCheck(role.Buyer, role.Manager, role.Admin)).DELETE("/PlanetsRequests", h.DeletePlanetRequest)
	//router.PUT("/PlanetsRequests", h.UpdatePlanetNumberInRequest)
	router.Use(h.WithAuthCheck(role.Buyer, role.Manager, role.Admin)).PUT("/PlanetsRequests", h.UpdatePlanetNumberInRequest)
	//router.GET("/users", h.UsersList)
